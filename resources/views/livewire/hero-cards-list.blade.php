                                    ...
                                    <div class="space-y-4" wire:loading.class="opacity-25" wire:loading.attr="disabled">
                                        <div class="text-sm font-bold text-slate-300 space-y-2 p-3 rounded-md bg-slate-800 border border-slate-700 shadow-sm">
                                            ...
                                            <div class="flex justify-between">
                                                ...
                                                <button class="flex items-center space-x-2 text-gray-400 hover:text-slate-500 text-sm leading-5 font-medium focus:outline-none focus:underline transition duration-150 ease-in-out" wire:click="removeFile(logo)">
                                    ...
                                    <div class="space-y-4" wire:loading.class="opacity-25" wire:loading.attr="disabled">
                                        <div class="text-sm font-bold text-slate-300 space-y-2 p-3 rounded-md bg-slate-800 border border-slate-700 shadow-sm">
                                            <div class="flex justify-between">
                                                ...
                                                <button class="flex items-center space-x-2 text-gray-400 hover:text-slate-500 text-sm leading-5 font-medium focus:outline-none focus:underline transition duration-150 ease-in-out" wire:click="removeFile(heroCard)">
                                                <x-dynamic-component component="fas-trash-can" class="h-4 w-4" />
                                                Remove File
                                            </button>
                                            </div>
