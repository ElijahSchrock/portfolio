                        ...
                        <div class="relative isolate bg-no-repeat bg-cover bg-center bg-transparent" style="background-image: url({{ $heroCard->getFirstMedia('heroCard')?->getURL() ?? null }})">
                            ...
                            <div class="mx-auto px-6 lg:flex lg:items-center lg:gap-x-10 lg:px-8 relative">
                                <div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
                                    ...
                                    <div class="ml-4 flex items-center gap-x-6" wire:click="$dispatch('openModal', { component: 'project-modal', arguments: { project: {{ $heroCard->project->id ?? null}} }})">
                                        <span class="rounded-md bg-gray-100 px-3.5 py-2.5 text-lg font-semibold shadow-sm hover:bg-gray-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300 flex justify-center items-center hover:cursor-pointer">
